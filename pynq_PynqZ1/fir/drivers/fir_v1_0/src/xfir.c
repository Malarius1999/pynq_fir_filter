...
void XFir_Set_input_r(XFir *InstancePtr, u64 Data) {
    ...
    XFir_WriteReg(InstancePtr->Control_BaseAddress, XFIR_CONTROL_ADDR_INPUT_R_DATA, (u32)(Data));
    XFir_WriteReg(InstancePtr->Control_BaseAddress, XFIR_CONTROL_ADDR_INPUT_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XFir_Get_input_r(XFir *InstancePtr) {
    ...
    Data += (u64)XFir_ReadReg(InstancePtr->Control_BaseAddress, XFIR_CONTROL_ADDR_INPUT_R_DATA + 4) << 32;
    return Data;
}
...
void XFir_Set_output_r(XFir *InstancePtr, u64 Data) {
    ...
    XFir_WriteReg(InstancePtr->Control_BaseAddress, XFIR_CONTROL_ADDR_OUTPUT_R_DATA, (u32)(Data));
    XFir_WriteReg(InstancePtr->Control_BaseAddress, XFIR_CONTROL_ADDR_OUTPUT_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XFir_Get_output_r(XFir *InstancePtr) {
    ...
    Data += (u64)XFir_ReadReg(InstancePtr->Control_BaseAddress, XFIR_CONTROL_ADDR_OUTPUT_R_DATA + 4) << 32;
    return Data;
}
